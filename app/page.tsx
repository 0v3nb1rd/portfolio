            ...
            <div className="bg-card text-foreground relative col-span-full flex h-full items-center justify-center overflow-hidden rounded-md border p-4 shadow">
              <div className="flex flex-col gap-2">
                ...
                <i className="text-muted-foreground text-lg">
                  ...
                  love clean design, structured code and learning from smart people. For me, development isn’t just a
                  job — it’s how I express creativity and logic together. Currently I focus on building scalable
          ...
          <li className="height-auto relative col-span-full flex flex-col lg:col-span-1 lg:col-start-1 lg:row-span-2 lg:row-start-3">
            <div className="bg-card text-foreground relative col-span-full flex h-full items-center justify-center overflow-hidden rounded-md border p-4 shadow">
              ...
              <div className="flex flex-col gap-2">
                ...
                <i className="text-muted-foreground text-lg">
                  I specialize in modern web technologies including React, Next.js, TypeScript, and Node.js. My toolkit
                  extends to TailwindCSS for styling, and I'm experienced with building scalable frontends and robust
                  APIs. I focus on writing clean, maintainable code and creating intuitive user experiences.
                </i>
              </div>
            </div>
          </li>
